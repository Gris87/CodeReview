...
public final class GoSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates GoSyntaxParser instance
     * @param context    context
     */
    private GoSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static GoSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("go", sourceCode);
