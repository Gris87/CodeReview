...
public final class CssSyntaxParser extends SyntaxParserBase
{
    @SuppressWarnings("unused")
    private static final String TAG = "CssSyntaxParser";



    /**
     * Creates CssSyntaxParser instance
     * @param context    context
     */
    private CssSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static CssSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("css", sourceCode);
