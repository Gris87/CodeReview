...
public final class BasicSyntaxParser extends SyntaxParserBase
{
    @SuppressWarnings("unused")
    private static final String TAG = "BasicSyntaxParser";



    /**
     * Creates BasicSyntaxParser instance
     * @param context    context
     */
    private BasicSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static BasicSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("basic", sourceCode);
