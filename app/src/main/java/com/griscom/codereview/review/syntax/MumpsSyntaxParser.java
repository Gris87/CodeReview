...
public final class MumpsSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates MumpsSyntaxParser instance
     * @param context    context
     */
    private MumpsSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static MumpsSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("mumps", sourceCode);
