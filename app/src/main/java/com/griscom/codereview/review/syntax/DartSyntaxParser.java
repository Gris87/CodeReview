...
public class DartSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates DartSyntaxParser instance
     * @param context    context
     */
    private DartSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static DartSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("dart", sourceCode);
