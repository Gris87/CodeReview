...
public class HaskellSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates HaskellSyntaxParser instance
     * @param context    context
     */
    private HaskellSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static HaskellSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("hs", sourceCode);
