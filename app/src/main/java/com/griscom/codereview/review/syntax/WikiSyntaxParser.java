...
public class WikiSyntaxParser extends SyntaxParserBase
{
     ...
     */
    private WikiSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static WikiSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("wiki.meta", sourceCode);
