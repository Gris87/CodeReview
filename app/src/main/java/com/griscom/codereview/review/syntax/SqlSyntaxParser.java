...
public class SqlSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates SqlSyntaxParser instance
     * @param context    context
     */
    private SqlSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static SqlSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("sql", sourceCode);
