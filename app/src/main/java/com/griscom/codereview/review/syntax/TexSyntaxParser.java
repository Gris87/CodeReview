...
public final class TexSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates TexSyntaxParser instance
     * @param context    context
     */
    private TexSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static TexSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("tex", sourceCode);
