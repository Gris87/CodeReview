...
public class YamlSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates YamlSyntaxParser instance
     * @param context    context
     */
    private YamlSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static YamlSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("yaml", sourceCode);
