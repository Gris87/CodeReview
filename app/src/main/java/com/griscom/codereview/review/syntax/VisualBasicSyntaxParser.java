...
public class VisualBasicSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates VisualBasicSyntaxParser instance
     * @param context    context
     */
    private VisualBasicSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static VisualBasicSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("vb", sourceCode);
