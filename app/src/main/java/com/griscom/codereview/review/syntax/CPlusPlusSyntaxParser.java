...
public class CPlusPlusSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates CPlusPlusSyntaxParser instance
     * @param context    context
     */
    private CPlusPlusSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static CPlusPlusSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("cpp", sourceCode);
