...
public class CssStrSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates CssStrSyntaxParser instance
     * @param context    context
     */
    private CssStrSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static CssStrSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("css - str", sourceCode);
