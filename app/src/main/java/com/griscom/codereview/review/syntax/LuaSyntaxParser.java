...
public final class LuaSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates LuaSyntaxParser instance
     * @param context    context
     */
    private LuaSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static LuaSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("lua", sourceCode);
