...
public class LispSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates LispSyntaxParser instance
     * @param context    context
     */
    private LispSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static LispSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("lisp", sourceCode);
