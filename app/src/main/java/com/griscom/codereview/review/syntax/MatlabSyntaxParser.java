...
public final class MatlabSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates MatlabSyntaxParser instance
     * @param context    context
     */
    private MatlabSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static MatlabSyntaxParser newInstance(Context context)
    {
