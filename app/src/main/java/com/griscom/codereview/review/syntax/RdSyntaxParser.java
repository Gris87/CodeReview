...
public class RdSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates RdSyntaxParser instance
     * @param context    context
     */
    private RdSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static RdSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("rd", sourceCode);
