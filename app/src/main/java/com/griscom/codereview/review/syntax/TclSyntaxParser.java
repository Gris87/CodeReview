...
public final class TclSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates TclSyntaxParser instance
     * @param context    context
     */
    private TclSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static TclSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("tcl", sourceCode);
