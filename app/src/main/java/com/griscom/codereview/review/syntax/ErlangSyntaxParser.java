...
public final class ErlangSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates ErlangSyntaxParser instance
     * @param context    context
     */
    private ErlangSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static ErlangSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("erlang", sourceCode);
