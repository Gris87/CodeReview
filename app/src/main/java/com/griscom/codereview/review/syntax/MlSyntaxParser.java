...
public final class MlSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates MlSyntaxParser instance
     * @param context    context
     */
    private MlSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static MlSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("ml", sourceCode);
