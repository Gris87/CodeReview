...
public class MatlabOperatorsSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates MatlabOperatorsSyntaxParser instance
     * @param context    context
     */
    private MatlabOperatorsSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static MatlabOperatorsSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("matlab - operators", sourceCode);
