...
public class MatlabIdentifiersSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates MatlabIdentifiersSyntaxParser instance
     * @param context    context
     */
    private MatlabIdentifiersSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static MatlabIdentifiersSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("matlab - identifiers", sourceCode);
