...
public class CssKwSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates CssKwSyntaxParser instance
     * @param context    context
     */
    private CssKwSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static CssKwSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("css - kw", sourceCode);
