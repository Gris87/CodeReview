...
public final class VhdlSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates VhdlSyntaxParser instance
     * @param context    context
     */
    private VhdlSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static VhdlSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("vhdl", sourceCode);
