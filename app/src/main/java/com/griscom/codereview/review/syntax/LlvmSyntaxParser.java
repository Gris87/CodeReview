...
public class LlvmSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates LlvmSyntaxParser instance
     * @param context    context
     */
    private LlvmSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static LlvmSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("llvm", sourceCode);
