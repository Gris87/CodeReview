...
public class ScalaSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates ScalaSyntaxParser instance
     * @param context    context
     */
    private ScalaSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static ScalaSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("scala", sourceCode);
