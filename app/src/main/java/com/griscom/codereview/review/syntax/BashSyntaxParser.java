...
public class BashSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates BashSyntaxParser instance
     * @param context    context
     */
    private BashSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static BashSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("sh", sourceCode);
