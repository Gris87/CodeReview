...
public class PascalSyntaxParser extends SyntaxParserBase
{
    ...
    /**
     * Creates PascalSyntaxParser instance
     * @param context    context
     */
    private PascalSyntaxParser(Context context)
    {
        super(context);
    }
     ...
     * @param context    context
     */
    public static PascalSyntaxParser newInstance(Context context)
    {
    ...
    public TextDocument parseFile(String filePath)
    {
        ...
        try
        {
            ...
            List<ParseResult> results = new PrettifyParser().parse("pascal", sourceCode);
