...
public class NumberPickerDialogPreference extends DialogPreference
{
    ...
    public NumberPickerDialogPreference(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            setMinValue(a.getInteger(R.styleable.NumberPickerDialogPreference_minimum, DEFAULT_MIN_VALUE));
            setMaxValue(a.getInteger(R.styleable.NumberPickerDialogPreference_maximum, DEFAULT_MAX_VALUE));
        }
        finally
        {
            a.recycle();
